...
if __name__ == '__main__':
    ...
    parser.add_argument("-bert_data_path", default='../bert_data/NLPCC')
    parser.add_argument("-model_path", default='../models/')
    parser.add_argument("-result_path", default='../results/NLPCC')
    ...
    parser.add_argument('-log_file', default='../logs/NLPCC.log')
